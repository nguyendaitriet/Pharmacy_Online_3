    ...
    page.dialogs.element.frmCreDrug.validate({
        ...
        showErrors: function(errorMap, errorList) {
            if (this.numberOfInvalids() > 0) {
                $("#mdCreateDrug .modal-alert-danger").removeClass("hide").addClass("show");
            } else {
                $("#mdCreateDrug .modal-alert-danger").removeClass("show").addClass("hide").empty();
                $("#frmCreDrug input.error").removeClass("error");
            }
